        ...
        for(let p=0; p<empresas[e].productos.length;p++){
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <center>
                        <a class="button MODAL-BUTTON button-fav-p" href="#popup1" onclick="generarPopUp(${e},${p})">
                            ver detalles
                        </a>
                    </center>
                </div>
    ...
    for(let e=0; e<empresas.length;e++){
        ...
        <div class="VENTAJAS-DE-ALL-PROMO-contenedor">
            ...
            <div class="VENTAJAS-DE-ALL-PROMO-overlay">
                ...
                <a>
                    <button type="button" class="button btn-primary"  onclick="generarEmpresa(${e})" button" data-toggle="modal" data-target="#">
                    Ir al perfil
                    </button>
                </a>
            </div> 
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="${empresas[e].banner}" class="d-block w-100 visible-md visible-lg" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="detalles-empresa col-md-9 col-lg-9 col-sm-6">
                        <div>
                            ...
                            <a href="#" class="fa fa-phone">&nbsp;&nbsp;&nbsp; ${empresas[e].telefono}</a><br>
